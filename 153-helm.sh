...
helm install --version 13.6.0 amp-prometheus-chart prometheus-community/prometheus -n prometheus -f ~/environment/observ/workshopfiles/one-observability-demo/PetAdoptions/cdk/pet_stack/resources/amp_ingest_override_values.yaml \
